...
Operational schema references (not historical day plans).

| Doc | Covers |
|-----|--------|
| [day4-schema.md](day4-schema.md) | AI reliability / runs / configs |
| [day5-schema.md](day5-schema.md) | Email, attachments, delivery, channels |
